-- =====================================================
-- KMRL Metro Email Classification System - Setup with Existing Users
-- =====================================================
-- This script sets up the email classification system
-- assuming the users table already exists
-- Run this in your Supabase SQL Editor

-- =====================================================
-- 1. CREATE EMAIL DATA TABLE
-- =====================================================
...
-- =====================================================
-- 2. CREATE EMAIL ATTACHMENTS TABLE
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '   ✅ users - Existing table (preserved)';
